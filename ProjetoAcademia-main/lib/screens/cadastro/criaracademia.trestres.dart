...
import 'package:lojavirtual/screens/cadastro/criaracademia.quatro.dart';
import 'package:provider/provider.dart';

class CriarAcademiatrestresScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CriarAcademiatrestresScreens();
  }
}
...
class CriarAcademiatrestresScreens extends State<CriarAcademiatrestresScreen> {
                  ...
                  return ListView(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        onSaved: (valorplano1) =>
                            academiacriar.planotresvalorAcademy = valorplano1,
                      ),
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: // userManager.loading
                            ...
                            if (formKey.currentState.validate()) {
                              ...
                              ////////////////////////////////////
                              academiacriar.planotresnameAcademy = 'Plano 3';
                              ///////////////////////////////////////////////
                              academiacriar.qtdplanotresAcademy =
                                  qtdSelecionado;
                              //////////////////////////////////////////////
                              ...
                              if (instrutorSelecionado ==
                                  ' Sem Instrutor (Personal Trainer)') {
                                academiacriar.intrutorplanotresAcademy = false;
                              } else {
                                academiacriar.intrutorplanotresAcademy = true;
                              }
                              /////////////////////////////////////////////
