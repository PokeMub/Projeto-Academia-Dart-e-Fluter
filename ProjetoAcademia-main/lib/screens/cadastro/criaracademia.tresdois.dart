...
import 'package:lojavirtual/screens/cadastro/criaracademia.trestres.dart';
import 'package:provider/provider.dart';

class CriarAcademiatresdoisScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CriarAcademiatresdoisScreens();
  }
}
...
class CriarAcademiatresdoisScreens extends State<CriarAcademiatresdoisScreen> {
                  ...
                  return ListView(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        onSaved: (valorplano1) =>
                            academiacriar.planodoisvalorAcademy = valorplano1,
                      ),
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: // userManager.loading
                            ...
                            if (formKey.currentState.validate()) {
                              ...
                              academiacriar.planoumnameAcademy = userManager
                              ...
                              ////////////////////////////////////
                              academiacriar.planodoisnameAcademy = 'Plano 2';
                              ///////////////////////////////////////////////
                              academiacriar.qtdplanodoisAcademy =
                                  qtdSelecionado;
                              //////////////////////////////////////////////
                              ...
                              if (instrutorSelecionado ==
                                  ' Sem Instrutor (Personal Trainer)') {
                                academiacriar.intrutorplanodoisAcademy = false;
                              } else {
                                academiacriar.intrutorplanodoisAcademy = true;
                              }
                              /////////////////////////////////////////////
